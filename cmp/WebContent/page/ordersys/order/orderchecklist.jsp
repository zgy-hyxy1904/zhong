...
<script>
	$(function(){
		$("#queryBtn").click(function(){
			queryForm.action="${pageContext.request.contextPath }/contorller/OrderContorller?flag=queryShenHe";
			queryForm.submit();
		});
		var count = ${sum};
		$("#down").click(function(){			
...
<div class="content-pages-wrap">
    ...
    <table width="101%" border="0" cellpadding="0" cellspacing="1" class="commonTable">
        ...
        <tr>
			...
			<c:if test="${order.orderFlag=='0' }">
            <td align="center">
				<a href="${pageContext.request.contextPath }/contorller/OrderContorller?flag=pass&orderIdPass=${order.orderId }" ><font color="BLUE">通过</font></a>
            	<a href="${pageContext.request.contextPath }/contorller/OrderContorller?flag=noPass&orderIdNoPass=${order.orderId }" ><font color="BLUE">不通过</font></a>
            </td>
            </c:if>
            <c:if test="${order.orderFlag=='1' }">
            <td align="center">
    ...
    <!--//commonTable-->
    <form name="pageForm" action="${pageContext.request.contextPath }/contorller/OrderContorller?flag=queryShenHe" method="post">
